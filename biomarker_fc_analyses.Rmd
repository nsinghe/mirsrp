...
tau_data_merge <- merge(tau_data_merge, df_cog, by="MAPID", all.x = TRUE) %>%
...
table(data_cdr$CDR, data_cdr$visit_final)

data = data%>%
  filter(CDR == 0)%>%
  filter(visit_final == 1)
#FINAL SAMPLE = 187 WITH 4 YEAR CUTOFF
#FINAL SAMPLE = 190 WITH 7 YEAR CUTOFF
...
data_cdr01 <- rbind(data, data_cdr)
#FINAL SAMPLE = 187 + 25 = 212
...
data_cdr01 <- data_cdr01 %>%
  mutate(age_tau=abs(as.Date(BIRTH,format = "%m/%d/%Y")-as.Date(date_tau,format = "%m/%d/%Y"))/365.25)
  #age_tau = age_tau/365.25
data_cdr01$age_tau <- as.numeric(data_cdr01$age_tau)
...
#extended analysis after final presentation
```{r}
#create a new grouping

data_cdr01$PibCategory <- cut(data_cdr01$pib_fsuvr_rsf_tot_cortmean, breaks = c(-Inf, 1.42, +Inf), labels = c("Aneg", "Apos"))
data_cdr01$av45Category <- cut(data_cdr01$av45_fsuvr_rsf_tot_cortmean, breaks = c(-Inf, 1.19, +Inf), labels = c("Aneg", "Apos"))

data_cdr01$AmyloidCategory <-with(data_cdr01, ifelse(
...
data_cdr01$TauCategory <- cut(data_cdr01$Tauopathy, breaks = c(-Inf, 1.22, +Inf), labels = c("TauNegative", "TauPositive")) 
table(data_cdr01$TauCategory) #124 TauNeg & 86 TauPos

data_cdr01$AmyloidTauCategory <-with(data_cdr01, ifelse(
...
table(data_cdr01$AmyloidTauCategory) # 100 A-T-, 36 A-T+, 17 A+T-, 34 A+T+, 25 Symptomatic AD
...
```{r}
#SAL x SAL analysis
kruskal.test(data_cdr01$SAL_x_SAL ~ data_cdr01$AmyloidTauCategory,  data = data_cdr01)
compare_means(SAL_x_SAL ~ AmyloidTauCategory,  data = data_cdr01, method = "wilcox")
...
p<-ggplot(data_cdr01, aes(x=AmyloidTauCategory, y=SAL_x_SAL, fill=AmyloidTauCategory)) +
  labs(title="SAL FC",x="", y = "SAL x SAL FC") +
...
```{r}
#DAN x DAN analysis
kruskal.test(data_cdr01$DAN_x_DAN ~ data_cdr01$AmyloidTauCategory,  data = data_cdr01)
compare_means(DAN_x_DAN ~ AmyloidTauCategory,  data = data_cdr01, method = "wilcox")
my_comparisons <- list( #c("A-T-", "A+T-"), c("A+T-", "A+T+"), c("A-T-", "A+T+"),
  # c("A-T-", "A+T-")
  #, c("A+T-", "A+T+"), 
  #c("A-T-", "A+T+")
...
p<-ggplot(data_cdr01, aes(x=AmyloidTauCategory, y=DAN_x_DAN, fill=AmyloidTauCategory)) +
  labs(title="DAN FC",x="", y = "DAN x DAN FC") +
  geom_violin(trim=FALSE, color = "black") + 
  scale_fill_manual(breaks=c("A-T-", "A+T-", "A-T+", "A+T+", "Symptomatic AD"),
                    values=c("blue", "yellow", "forestgreen", "orange", "red")) +
...
```{r}
#DMN x DMN analysis
kruskal.test(data_cdr01$DMN_x_DMN ~ data_cdr01$AmyloidTauCategory,  data = data_cdr01)
compare_means(DMN_x_DMN ~ AmyloidTauCategory,  data = data_cdr01, method = "wilcox")
my_comparisons <- list( #c("A-T-", "A+T-"), c("A+T-", "A+T+"), c("A-T-", "A+T+"),
  # c("A-T-", "A+T-")
  #, c("A+T-", "A+T+"), 
  #c("A-T-", "A+T+")
...
p<-ggplot(data_cdr01, aes(x=AmyloidTauCategory, y=DMN_x_DMN, fill=AmyloidTauCategory)) +
  labs(title="DMN FC",x="", y = "DMN x DMN FC") +
  geom_violin(trim=FALSE, color = "black") + 
  scale_fill_manual(breaks=c("A-T-", "A+T-", "A-T+", "A+T+", "Symptomatic AD"),
                    values=c("blue", "yellow", "forestgreen", "orange", "red")) +
...
## CO
```{r}
kruskal.test(data_cdr01$CO_x_CO ~ data_cdr01$AmyloidTauCategory,  data = data_cdr01)
compare_means(CO_x_CO ~ AmyloidTauCategory,  data = data_cdr01, method = "wilcox")
my_comparisons <- list( #c("A-T-", "A+T-"), c("A+T-", "A+T+"), c("A-T-", "A+T+"),
  # c("A-T-", "A+T-")
  #, c("A+T-", "A+T+"), 
  #c("A-T-", "A+T+")
  #, c("A+T+", "CDR > 0"), c("A+T-", "CDR > 0"), c("A-T-", "CDR > 0")
  c("A-T-", "A-T+"), c("A-T-", "Symptomatic AD"), c("A+T-", "Symptomatic AD")
)

#Violin Plot of CO x CO
p<-ggplot(data_cdr01, aes(x=AmyloidTauCategory, y=CO_x_CO, fill=AmyloidTauCategory)) +
  labs(title="PETMR DATASET: CO FC",x="", y = "CO x CO FC") +
  geom_violin(trim=FALSE, color = "black") + 
  scale_fill_manual(breaks=c("A-T-", "A+T-", "A-T+", "A+T+", "Symptomatic AD"),
                    values=c("blue", "yellow", "forestgreen", "orange", "red")) +
...
## FP
```{r}
kruskal.test(data_cdr01$FP_x_FP ~ data_cdr01$AmyloidTauCategory,  data = data_cdr01)
compare_means(FP_x_FP ~ AmyloidTauCategory,  data = data_cdr01, method = "wilcox")
my_comparisons <- list( #c("A-T-", "A+T-"), c("A+T-", "A+T+"), c("A-T-", "A+T+"),
  # c("A-T-", "A+T-")
  #, c("A+T-", "A+T+"), 
  #c("A-T-", "A+T+")
...
#Violin Plot of CO x CO
p<-ggplot(data_cdr01, aes(x=AmyloidTauCategory, y=FP_x_FP, fill=AmyloidTauCategory)) +
  labs(title="FP FC",x="", y = "FP x FP FC") +
  geom_violin(trim=FALSE, color = "black") + 
  scale_fill_manual(breaks=c("A-T-", "A+T-", "A-T+", "A+T+", "Symptomatic AD"),
                    values=c("blue", "yellow", "forestgreen", "orange", "red")) +
...
data_cdr01$z_global_srt = scale(data_cdr01$srtfree)
data_cdr01$z_global_animal = scale(data_cdr01$ANIMALS)
data_cdr01$z_global_tma = -1*(scale(data_cdr01$tma))
data_cdr01$z_global_tmb = -1*(scale(data_cdr01$tmb))

data_cdr01$global_comp <- rowMeans(subset(data_cdr01, select = c(
  z_global_srt,
  z_global_animal,
  z_global_tma,
  z_global_tmb
...
g = ggplot(data_cdr01, aes(y = global_comp, x = DMN_x_DMN))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual DMN x DMN", y = "Global Cognition (composite)") +
...
g = ggplot(data_cdr01, aes(y = global_comp, x = SAL_x_SAL))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual SAL x SAL", y = "Global Cognition (composite)") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01, aes(y = global_comp, x = DAN_x_DAN))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual DAN x DAN", y = "Global Cognition (composite)") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01, aes(y = global_comp, x = CO_x_CO))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual CO x CO", y = "Global Cognition (composite)") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01, aes(y = global_comp, x = FP_x_FP))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual FP x FP", y = "Global Cognition (composite)") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
```{r}
hist(data_cdr01$CSF_sTREM2, breaks=20)
data_cdr01_trem = subset(data_cdr01, CSF_sTREM2 < 5000) #170 obs
...
g = ggplot(data_cdr01_trem, aes(y = CSF_sTREM2, x = DMN_x_DMN))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual DMN x DMN", y = "CSF sTREM2") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01_trem, aes(y = CSF_sTREM2, x = SAL_x_SAL))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual SAL x SAL", y = "CSF sTREM2") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01_trem, aes(y = CSF_sTREM2, x = DAN_x_DAN))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual DAN x DAN", y = "CSF sTREM2") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01_trem, aes(y = CSF_sTREM2, x = CO_x_CO))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual CO x CO", y = "CSF sTREM2") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
...
g = ggplot(data_cdr01_trem, aes(y = CSF_sTREM2, x = FP_x_FP))
g + geom_point(aes(color = AmyloidTauCategory)) +
  labs(title="", x = "Residual FP x FP", y = "CSF sTREM2") +
  geom_smooth(aes(color = AmyloidTauCategory, fill = AmyloidTauCategory), method = glm) +
  geom_smooth(color = 'black', method = glm, linetype = 'dashed') +
  scale_color_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
  scale_fill_manual(values = c("blue", "forestgreen", "yellow", "orange", "red")) +
